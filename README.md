> [!CAUTION]  
> This repository was recently forked (2025-02-28) in order to add support for
> SMIME certificates and Systemd. Automation (with tests) will also be added.
> Do not use this repository for anything other than development and testing
